...
try{
 ...
 let boards=await execute(`return penpot.currentPage.root.children.filter(b=>b.name.startsWith('Desktop / Main / Message')||b.name.startsWith('Desktop / Main / Attachment')).map(b=>({id:b.id,name:b.name}));`);
