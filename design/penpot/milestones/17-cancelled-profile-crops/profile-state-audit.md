...
| Empty required username | Native browser constraint validation | Native validation reference still missing |
...
| Revoke another Session | window.confirm before mutation | OS-native confirmation reference still missing |
