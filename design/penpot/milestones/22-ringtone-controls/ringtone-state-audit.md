...
Milestone 21 adds failed replacement while custom audio remains active, reset with generated-tone fallback but retained Community-reset notice, and 50% volume. Milestone 22 adds file-input/reset/slider keyboard-focus references and 960×640 default, custom and scrolled custom layouts. Remaining: file-picker native appearance, hover styles and full runtime geometry/typography comparison. Community-administration ringtone settings use a separate scope and controls, and remain queued with that screen.
