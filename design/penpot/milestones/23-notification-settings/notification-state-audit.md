...
Remaining: expanded native Community/Channel select menus, all Community selected levels, Community/channel save success and failure notices, optimistic-value retention on failure, control focus/hover, minimum-window and scrolled states, full runtime geometry and typography review. Community options are All Messages / Only @mentions / Nothing. Channel options add Community default.
