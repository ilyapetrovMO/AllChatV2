...
Milestone 24 adds expanded Community/Channel menus, Community All Messages selection, all four save success/failure notices and retained values after failure. Remaining: control focus/hover, minimum-window and scrolled states, full runtime geometry and typography review; cross-platform native menu differences. Community options are All Messages / Only @mentions / Nothing. Channel options add Community default.
