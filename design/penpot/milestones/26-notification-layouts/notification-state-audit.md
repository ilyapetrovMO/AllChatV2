...
Milestone 24 adds expanded Community/Channel menus, Community All Messages selection, all four save success/failure notices and retained values after failure. Milestone 25 adds keyboard-focus references for both levels, Community mute, notification sound and channel mute. Milestone 26 adds both select-hover references and 960×640 initial/scrolled layouts for a single channel. Remaining: long-channel/multi-row minimum variants and full runtime geometry/typography review; cross-platform native menu differences. Community options are All Messages / Only @mentions / Nothing. Channel options add Community default.
