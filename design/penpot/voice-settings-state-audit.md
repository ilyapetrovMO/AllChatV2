...
Milestone 39 adds minimum-window camera-on landscape and portrait views plus a started-notice bottom view. Local synthetic streams measured preview heights 304.875px and 320px respectively; portrait media is 180px wide inside the 542px preview. Content heights and scroll positions follow the source fixture. Native color bars represent arbitrary video content. Exported text and geometry checked, all three views visually reviewed, zero interactions. Device edge fixtures and full runtime/platform fidelity remain open.
