...
(() => {
  ...
  if (document.querySelector(".app-shell")) installDirectMessageInbox();
	...
	if(document.querySelector(".channel-nav"))installVoiceChannelPresence().catch(()=>{}).finally(()=>Promise.all([
	  import("/assets/rnnoise.js"),
	  import("/assets/voice-settings.js"),
	  import("/assets/voice-connection.js"),
	]).then(()=>import("/assets/voice-sidebar.js")).catch(()=>{}));
