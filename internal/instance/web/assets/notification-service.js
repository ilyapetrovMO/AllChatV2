...
(function (global) {
  ...
  const installNotificationCenter = async () => {
    ...
    const installBell = () => {
      ...
      const ringtoneLink=document.createElement("a");ringtoneLink.href="/ringtone";ringtoneLink.textContent="Ringtone settings";
      ...
      popover.append(heading, settingsStatus, permission, communityLabel, communityMute, sound, ringtoneLink);
